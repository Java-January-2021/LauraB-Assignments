...
public class ListOfExceptions{
    ...
    public static void main(String[] args) {
        ...
        myList.add(48);
        myList.add("Goodbye for today --> See you tomorrow.");
        ...
        //Use try/catch blocks to handle the exceptions
            ...
            try{
                ...
                System.out.println(CYAN_BOLD_BRIGHT + castedValue + RESET);
            }
            catch(Exception error){
                System.out.println(RED_BOLD_BRIGHT + "Exception error. Check your code." + RESET);
            }
        }
    }
}
