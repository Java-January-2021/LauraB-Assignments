public class StringManipulatorController{
    ...
    System.out.println();
    System.out.println("***********Integer getIndexOrNull(String, char)************");
    System.out.println();
...
//***********Integer getIndexOrNull(String, char) ************/
    ...
    System.out.println(ANSI_RED + c1 + ANSI_RESET + " --> The letter 'o' does not appear in 'Hi'."); // null
    System.out.println();
...
//***********Integer getIndexOrNull(String, String) ************/
    ...
    System.out.println();
    System.out.println("***********Integer getIndexOrNull(String, String)************");
    System.out.println();
...
//***********String concatSubstring(String, int, int, String)************/
    ...
    System.out.println();
    System.out.println("***********String concatSubstring(String, int, int, String)************");
    System.out.println();
