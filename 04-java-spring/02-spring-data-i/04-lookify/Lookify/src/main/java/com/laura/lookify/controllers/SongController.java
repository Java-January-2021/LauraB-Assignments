package com.laura.lookify.controllers;
...
import com.laura.lookify.services.SongService;
...
public class SongController {
	...
	public String editSong(@Valid @ModelAttribute("Song") Song song, BindingResult result, @PathVariable("id") Long id, Model viewModel) {
		...
		if(result.hasErrors()) {			
			...
			System.out.println("Song " + id + " Successfully Updated!");
		}
...
//		return "redirect:/songs/";
	...
	public String deleteSong(@PathVariable("id") Long id) {
		...
		System.out.println("Song " + id + " Successfully Deleted!");
