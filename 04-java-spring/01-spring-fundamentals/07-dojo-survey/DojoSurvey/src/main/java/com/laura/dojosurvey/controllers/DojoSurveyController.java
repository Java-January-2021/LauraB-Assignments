package com.laura.dojosurvey.controllers;
...
public class DojoSurveyController {
	...
	public String form(@RequestParam(value="userName") String userName, @RequestParam(value="email") String email, @RequestParam(value="dojoLocation") String dojoLocation, @RequestParam(value="selectLanguage") String selectLanguage, @RequestParam(value="comment") String comment, Model model) {
